...
题库由 `scripts/fetch-bangumi-seed.mjs` 通过 Bangumi API 分段抓取生成，输出到 `public/anime-seed.json`。当前题库约 7000 条动画；标准预设使用全量题库，赤石大王只保留评分 5.0 以下作品，婆罗门偏向 2010 年以前的小众作品。项目没有复制第三方站点的源码、样式文件或数据文件。
