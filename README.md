...
- EdgeOne Pages WebSocket 函数入口：`node-functions/websocket.js`
...
项目未复制第三方站点源码、样式文件或数据文件。

## 部署

面向中国大陆用户的免费部署方案可以使用 GitHub 托管源码、EdgeOne Pages 托管前端，并通过 `node-functions/websocket.js` 提供实时房间服务。
